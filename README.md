...
|-------|---------|-----------------|
| `opencode-delegator` | Delegates coding implementation tasks to OpenCode/GLM-5 | User asks GLM/OpenCode to write/implement code ("delegate to GLM", "have opencode build X", "let GLM do this") |
